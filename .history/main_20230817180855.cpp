...
// Define SumOperation, SubtractOperation, and EmptyOperation classes
...
// Define the Calculator class that chooses the strategy
class Calculator {
private:
    Operation* operation;
...
int main() {
    ...
    delete operation; // Don't forget to free memory
